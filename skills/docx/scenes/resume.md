...
new Paragraph({
  children: [
    ...
    new TextRun({
      text: "Java / Go / Python / TypeScript",
      size: 18,
      color: C.sec,
    }),
  ],
...
new Paragraph({
  borders: {
    left: { style: BorderStyle.SINGLE, size: 8, color: C.accent, space: 8 },
  },
  indent: { left: 120 },
  children: [
    new TextRun({
...
sections: [
  ...
  },
  {
    ...
    properties: {
      page: { margin: { top: 800, bottom: 600, left: 800, right: 800 } },
    },
