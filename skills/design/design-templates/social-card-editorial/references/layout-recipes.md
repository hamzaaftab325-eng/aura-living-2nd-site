  ...
  <div class="content stack gap-7">
    ...
    <div class="h-bar-chart">
      <div class="bar-row">
        ...
        <div class="row-track">
          <div class="row-fill" style="--w:94%"></div>
        </div>
      ...
      <div class="bar-row">
        ...
        <div class="row-track">
          <div class="row-fill" style="--w:78%"></div>
        </div>
      ...
      <div class="bar-row">
        ...
        <div class="row-track">
          <div class="row-fill" style="--w:62%"></div>
        </div>
      ...
      <div class="bar-row">
        ...
        <div class="row-track">
          <div class="row-fill" style="--w:48%"></div>
        </div>
      ...
      <div class="bar-row">
        ...
        <div class="row-track">
          <div class="row-fill" style="--w:36%"></div>
        </div>
      ...
      <div class="bar-row">
        ...
        <div class="row-track">
          <div class="row-fill" style="--w:28%"></div>
        </div>
