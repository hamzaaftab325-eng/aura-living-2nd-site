...
font-family:
  "{Latin字体}", "{CJK字体}", "PingFang SC", "Microsoft YaHei", system-ui,
  sans-serif;
/* 例： */
font-family:
...
```css
font-family:
  "Inter", system-ui, sans-serif; /* ✗ 中文 fallback 到 system-ui，不可控 */
font-family:
  "Helvetica", "PingFang SC"; /* ✗ 英文在前会抢走中文标点(破折号/引号下沉) */
```
...
body {
  font-family:
    "Inter Latin", "Noto Sans SC", "PingFang SC", system-ui, sans-serif;
}
```
