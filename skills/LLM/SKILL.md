      ...
      messages: [
        {
          role: "assistant",
          content:
            "You are a professional email writer. Write clear, concise, and polite emails.",
        },
        {
          role: "user",
...
async function analyzeData(data, analysisType) {
  ...
  const prompts = {
    summarize:
      "You are a data analyst. Summarize the key insights from the data.",
      ...
      messages: [
        {
          role: "assistant",
          content:
            "You are an expert debugger. Identify bugs and suggest fixes.",
        },
        {
          role: "user",
      ...
      messages: [
        {
          role: "assistant",
          content:
            "You are a programming teacher. Explain code clearly and simply.",
        },
        {
          role: "user",
...
const good = await askWithContext(
