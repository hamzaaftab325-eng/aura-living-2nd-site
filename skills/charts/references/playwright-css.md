  ...
  <head>
    ...
    <style>
      * {
      ...
      body {
        font-family:
          -apple-system, BlinkMacSystemFont, "PingFang SC", "SimHei", system-ui,
          sans-serif;
        background: var(--bg);
        color: var(--text);
...
function drawConnectors(connections) {
  ...
  svg
    .querySelectorAll("line, path, text.connector-label")
...
<div id="root">
  ...
  <div class="flow-legend">
    <div class="legend-item">
      <div
        class="legend-dot"
        style="border-color:#3B82F6;background:#EFF6FF;"
      ></div>
      步骤
    </div>
    <div class="legend-item">
  ...
  <div class="phase-group phase-1">
    ...
    <div class="phase-steps">
      <div class="phase-step">
        <span class="step-num">1</span>需求收集与整理
      </div>
      <div class="phase-step"><span class="step-num">2</span>可行性评估</div>
      <div class="phase-step">
        <span class="step-num">3</span>需求优先级排序
      </div>
    </div>
  </div>

  <!-- Phase-to-phase arrow (use SVG or simple centered down arrow) -->
  <div style="text-align:center; color:#94A3B8; font-size:24px; margin: 8px 0;">
    ↓
  </div>
